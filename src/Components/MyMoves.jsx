        ...
        {data.map((move, index) => (
          <div key={index} className="move">
            <div className="first_my_moves_box">
              ...
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px" fill="#EE553B">
            ...
            <div className="second_my_moves_box">
              <ul className='second_list'>
                <li>
                  <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#EE553B">
                ...
                <li>
                  <button className='viewbutton'>View move details</button>
          ...
          <p>
            <svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 -960 960 960" width="18px" fill="#EE553B">
              <path d="m40-120 440-760 440 760H40Zm138-80h604L480-720 178-200Zm302-40q17 0 28.5-11.5T520-280q0-17-11.5-28.5T480-320q-17 0-28.5 11.5T440-280q0 17 11.5 28.5T480-240Zm-40-120h80v-200h-80v200Zm40-100Z"/>
            </svg>
          </p>
          <p>Disclaimer: Please update your move date before two days of shifting</p>
        </div>
        <hr/>
          </div>
